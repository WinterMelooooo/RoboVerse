...
ckpt=info/outputs/DP/2025.06.16/16.17.54_Fusion_ResNet18_PointNet_Mutual_Attention_Dropout_StackCubeFrankaL0_obs:joint_pos_act:joint_pos/checkpoints/2000.ckpt
task=StackCube
num_envs=50
random_level=0
use_touch=0
