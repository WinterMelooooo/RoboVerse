...
class RobotImageDataset(BaseImageDataset):
    ...
    def postprocess(self, samples, device):
        ...
        assert samples["head_camera_depth"].shape[2] == 3, (
            f"head_camera_depth should be 3 channels, but got {samples['head_camera_depth'].shape}"
        )
        depth = (
        ...
        return {
            "obs": {
                "head_cam": head_cam.squeeze(),  # B, 4, H, W
