...
from mlp_policy.model.common.normalizer import (
    LinearNormalizer,
    ...
    def postprocess(self, samples, device):
        ...
        for i in range(B):
            ...
            for idx in range(self.n_obs_steps):
                pntcloud = masked_pnt_cloud[0].cpu().numpy()
        ...
        data = {
            "obs": {
                "qpos": agent_pos.squeeze(),  # B, D
                "pcds": point_cloud_batch,  # B, Dict[coord, color, feat, offset]
            },
