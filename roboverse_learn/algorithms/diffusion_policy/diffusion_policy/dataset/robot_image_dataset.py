...
class RobotImageDataset(BaseImageDataset):
    def __init__(
        ...
        print(f"Using cotraining: {cotraining}")
        print(f"Using simulation data from {zarr_path} with ratio {max_visible_ratio}%")
        print(f"Using real world data from {real_world_zarr_path} with ratio {real_world_ratio}%")
