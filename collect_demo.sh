...
bash roboverse_learn/algorithms/diffusion_policy/data2zarr.sh roboverse_demo/demo_isaaclab/StackCube-Level1/robot-franka StackCubeFrankaL1 1000 2,3,6,7 400 joint_pos joint_pos 0 1 1 1
