...
demo_start_idx=0
max_demo_idx=1000
target_num_demos=100
python metasim/scripts/collect_demo.py --task=${task_name} --num_envs=${num_envs} --run_all --headless --random.level=${random_level} --demo_start_idx=${demo_start_idx} --max_demo_idx=${max_demo_idx} --target_num_demos=${target_num_demos}
