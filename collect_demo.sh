...
num_envs=1
max_demo_idx=600
python metasim/scripts/collect_demo.py --task=${task_name} --num_envs=${num_envs} --run_all --headless --random.level=${random_level} --demo_start_idx 300 --max_demo_idx=${max_demo_idx}
