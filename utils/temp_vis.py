...
# 1. 指定保存 pcd_dict 的目录
file = r"/home/ghr/yktang/RoboVerse/tmp/visualize/StackCubeL0/demo_0000_step_0.npy"
if file.endswith(".npz"):
    ...
    # 直接加载 .npy 文件
    your_pointcloud = np.load(file)
    print(f"pointcloud shape: {your_pointcloud.shape}, dtype: {your_pointcloud.dtype}")
    visualizer.visualize_pointcloud(your_pointcloud)
